      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h6></h6>
            <p class="fst-italic">
            Kami adalah sumber terpercaya untuk mendapatkan informasi terkini seputar beasiswa. Di Beasinfo, kami berkomitmen untuk menyediakan panduan lengkap yang membantu Anda dalam mencari dan mengakses peluang beasiswa yang sesuai dengan kebutuhan pendidikan Anda.<br>
